	...
	describe("getAll", () => {
		...
		describe("filter query", () => {
			...
			it("should filter values with deep paths", () => {
				...
				expect(collection.getAll({ filter: { "deep.value": "b" } })).toEqual(
					expected,
				);
			});
			...
			it("should filter array values properly within deep paths", () => {
				...
				expect(collection.getAll({ filter: { "deep.tags": "b" } })).toEqual(
					expected,
				);
			...
			it("should filter array values properly inside deep paths", () => {
				...
				expect(collection.getAll({ filter: { "tags.deep": "b" } })).toEqual(
					expected,
				);
			...
			it("should filter array values properly with deep paths", () => {
				...
				expect(collection.getAll({ filter: { "tags.name": "b" } })).toEqual(
					expected,
				);
